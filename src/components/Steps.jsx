      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Finding your perfect property is easy with our simple five-step process
          </p>
        </motion.div>
        ...
        <motion.div
          ...
          className="grid grid-cols-1 md:grid-cols-5 gap-10 relative"
        >
          {/* Process line - desktop */}
          <div className="hidden md:block absolute top-10 left-[10%] right-[10%] h-0.5 bg-gray-100">
            ...
            <React.Fragment key={index}>
              ...
              {index < steps.length - 1 && (
                <div
                  ...
                  style={{
                    top: '29px',
                    left: `calc(${((index + 1) * 100) / steps.length}% - 12px)`
                  }}
                >
                  <motion.div
                    animate={{ x: [0, 10, 0] }}
        ...
        >
          <div className="bg-white p-8 rounded-xl shadow-xl border border-gray-50 text-center">
            <p className="text-gray-700 italic text-lg mb-4">
              {`"The 5-step process was incredibly smooth. Within a week, I found and secured my dream apartment!"`}
            </p>
