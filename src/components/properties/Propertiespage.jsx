...
const PropertiesPage = () => {
  ...
  useEffect(() => {
    const affordabilityParam = searchParams.get("type");
    if (affordabilityParam) {
      setFilters((prev) => ({
        ...prev,
        affordability: affordabilityParam.toLowerCase(),
      }));
    }
  }, [searchParams]);  
  ...
  const filteredProperties = useMemo(() => {
    return propertyState.properties
      .filter((property) => {
        ...
        const affordabilityMatch = !filters.affordability ||
          property.affordability?.toLowerCase() === filters.affordability.toLowerCase();
